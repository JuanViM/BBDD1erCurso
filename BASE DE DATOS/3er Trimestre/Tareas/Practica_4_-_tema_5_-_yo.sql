...
#/*Ejercicio 8*/ intentarlo que esta mal debe de mostrar el valor null
...
## /*Ejercicio 9*/  esta mal corregir
select e.apellido, e.dept_no,e.oficio
from departamentos d, empleado e
where e.dept_no=d.dept_no
and e.dept_no='20'
and e.oficioempleado in(select oficio from empleado where oficio != 'Empleado');
